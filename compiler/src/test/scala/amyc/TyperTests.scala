...
class TyperTests extends TestSuite {
  ...
  @Test def testArithmetic = shouldPass(List("String", "Arithmetic"))
  @Test def testComparison = shouldPass(List("String", "Comparison"))
  @Test def testConstructors = shouldPass(List("String", "Constructors"))
  @Test def testFunctionCalls = shouldPass(List("String", "FunctionCalls"))
  @Test def testIf = shouldPass(List("String", "If"))
  def testIfWithError = shouldPass("IfWithError")
  @Test def testLogical = shouldPass(List("String", "Logical"))
  @Test def testMatch1 = shouldPass(List("String", "Match1"))
  @Test def testMatch2 = shouldPass(List("String", "Match2"))
  @Test def testMatch3 = shouldPass(List("String", "Match3"))
  @Test def testMatchWithError = shouldPass(List("String", "MatchWithError"))
  @Test def testMisc = shouldPass(List("String", "Misc"))
  @Test def testSeq = shouldPass(List("String", "Seq"))
  def testSeqWithError = shouldPass("SeqWithError")
  def testLetWithError = shouldPass("LetWithError")
  @Test def testError = shouldPass(List("String", "Error"))

  @Test def highOrderFunctionParam = shouldPass(List("String", "FunctionInParameter"))

  @Test def highOrderFunctionRte = shouldPass(List("String", "FunctionInReturnType"))
